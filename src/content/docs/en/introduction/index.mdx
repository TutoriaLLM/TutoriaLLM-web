...
Additionally, programs created in tutorials are executed server-side and can integrate with other applications. Currently, integration with [Minecraft](/userguides/minecraft) is supported, allowing you to run your programs.
...
<Aside type="caution" title="Caution">
  TutoriaLLM is server software for creating tutorial-providing websites, not
