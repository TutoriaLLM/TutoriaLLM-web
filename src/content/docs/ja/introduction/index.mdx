...
さらに、チュートリアルで作成したプログラムはサーバー側で実行され、他のアプリケーションと連携することもできます。現在、[Minecraft との連携](/userguides/minecraft)が可能で、プログラムを実行することができます。
...
<LinkCard
  title="貢献する"
  description="TutoriaLLMをホストしたり、開発に貢献する方法を学びましょう。"
  href="/ja/developer/contribute"
/>
